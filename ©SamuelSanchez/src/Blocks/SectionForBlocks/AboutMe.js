...
const about = () => {
  useEffect(() => {
    ...
    const journey = {
        ...
        careerAspirations: "I am open to discussing Summer Internship opportunities in Software engineering for the Summer of 2025 or Winter 2024-2025 for my Junior year summer. I welcome the chance to collaborate with professionals across the industry and am confident in the meaningful contributions I can bring to any team. If you're interested in working together, please feel free to reach out—my contact information is available at the bottom of the site!"
      };
