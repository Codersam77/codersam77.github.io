...
const about = () => {
  useEffect(() => {
    ...
    const journey = {
        introduction: "Born and raised in the greater Greater Boston Area, I have had the privilege of growing up in an environment at the forefront of the technological advancements that have gone on around us. Coming from a mother who had very few opportunities growing up, was a first-generation student, came here on an H-1B Visa, and is currently a software engineer, I have had the opportunity to gain inspiration from her journey of overcoming many obstacles as one of the few Latinx women in tech. Since a young age, my parents have prepared me to have the best possible STEM skills and to effectively solve problems. Guided by my Afro-Hispanic roots, I actively embrace cultural inclusivity through involvement in prominent minority organizations, such as serving as a member of the National Society of Black Engineers chapter at UMass Amherst.",
        academicJourney: "Embracing my mother's legacy, I embarked on my own voyage into software engineering. My journey has been marked by a passion for innovation and solving problems, key pillars that have helped tremendously in my growth. In my high school years, at Xaverian Brothers High School, I began taking advanced computer science courses as well as tackling projects that got my hands wet with coding and Machine Learning. I also further developed my communication skills and abilities, serving as Class President all four years and Founding the Entrepreneurship Club.",
        collegeChallenges: "Transitioning to College, I have taken the most rigorous computer science classes my school offers, even taking a graduate-level statistics course, which relates heavily to work in Machine Learning (AI) in my sophomore year. I currently serve as a Full-Stack Software Engineer at BUILD Umass, an organization that focuses on creating solutions for startups, small businesses, and nonprofits. Last summer, I served as a Network Engineering Intern for Sullivan and McLaughlin Companies, New England‘s largest single-source technologies contracting company.",
      ...
      const renderPersonalJourney = () => {
        const { introduction, academicJourney, collegeChallenges, personalLife, careerAspirations } = journey;
