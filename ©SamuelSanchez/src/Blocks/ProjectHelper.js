 ...
 */
  ...
  return (
    <div
    className={`self-stretch overflow-hidden flex flex-row items-center justify-center py-5 px-0 box-border gap-[40px] [&.animate]:animate-[1s_ease_0s_1_normal_forwards_fade-in-left] opacity-[0] max-w-full text-left text-29xl text-primary-zinc-500 font-heading-h6-semibold mq825:gap-[10px] mq1425:flex-wrap mobile-spacing-adjustments`}
    data-animate-on-scroll
  >
      <div
        className="w-[594px] h-[476px] overflow-hidden shrink-0 flex flex-row items-center justify-center min-w-[594px] max-w-full cursor-pointer lg:min-w-full mq1425:flex-1 mq825:w-auto mq825:h-auto"
      ...
      <div className="flex-1 overflow-hidden flex flex-col items-start justify-center min-w-[378px] max-w-full mq825:min-w-full mq825:min-w-0">
