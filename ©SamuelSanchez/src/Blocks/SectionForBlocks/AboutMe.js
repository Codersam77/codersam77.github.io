...
const about = () => {
  useEffect(() => {
    ...
    const journey = {
        ...
        collegeChallenges: "Transitioning to College, I have taken the most rigorous computer science classes my school offers, even taking a graduate-level statistics course, which relates heavily to work in Machine Learning (AI) in my sophomore year. In addition to this, I have gained experience in the industry of software engineering, creating projects (which you can see below) and leading innovation through different roles I have taken part in. Guided by my Afro-Hispanic roots, I have made it an effort to champion minority voices in technology, ensuring that the technology we create is accessible, equitable, and reflective of the diverse world we inhabit. Notably, my engagement with the National Society of Black Engineers chapter at UMass Amherst has been a fulfilling avenue to contribute and affirm the importance of inclusive representation in STEM fields.",
